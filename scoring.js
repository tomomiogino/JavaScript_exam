...
$(document).ready(function(){
  ...
  function score_indicate(){
    ...
    // <追加課題1>を実装
    let sum = subject_points.reduce((total, point) => total += point, 0);
    // let sum = subject_points[0];  追加課題1を実装するため見本コードコメントアウト
    // sum = sum + subject_points[1];  追加課題1を実装するため見本コードコメントアウト
    // sum = sum + subject_points[2];  追加課題1を実装するため見本コードコメントアウト
    // sum = sum + subject_points[3];  追加課題1を実装するため見本コードコメントアウト
    // sum = sum + subject_points[4];  追加課題1を実装するため見本コードコメントアウト
  ...
  function get_pass_or_failure(){
    ...
    for (let i = 0; i < number; i++) {
      let subject_point = subject_points[i];
      if (subject_point < 60) {
        judge = "不合格";
        break;
      }
  ...
  $('#btn-declaration').click(function() {
    $('#alert-indicate').remove();  //追加課題2(既存の最終ジャッジ結果をクリアする処理)
